function show_protangonation_claw(map1,map2,pointSet1,pointSet2,s,pointOriSet1,pointOriSet2)
...
main_point2 = [xdistance+s*pointSet2(1,1), s*pointSet2(1,2)];
% show  claw
for i=2:N
    line([main_point1(1),s*pointSet1(i,1)],[main_point1(2),s*pointSet1(i,2)],'Color','b','LineWidth',2.6);
    line([main_point2(1),xdistance+s*pointSet2(i,1)],[main_point2(2),s*pointSet2(i,2)],'Color','b','LineWidth',2.6);
...
showPoint([xdistance+s*pointSet2(:,1),s*pointSet2(:,2)],false,20);
